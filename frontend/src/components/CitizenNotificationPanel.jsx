...
export default function CitizenNotificationPanel({ isOpen, onClose }) {
  const { notifications, unreadCount, markAsRead, markAllAsRead, isLoading } = useCitizenNotifications();
  ...
  return (
    <>
      ...
      {/* Notification Panel */}
      <div className="citizen-portal fixed right-0 top-0 z-50 h-screen w-full max-w-sm bg-white shadow-lg border-l border-slate-200 flex flex-col">
        {/* Header */}
